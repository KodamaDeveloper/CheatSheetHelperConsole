...
4. The plugin will execute the selected script the specified number of times and display the output.
...
def run(memory):
    ...
    for i in range(num_executions):
        ...
        if script_type == "sh":
            ...
            result = subprocess.run(f"python3 {script_path}", shell=True, capture_output=True, text=True)
